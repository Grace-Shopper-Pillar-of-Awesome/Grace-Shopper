module.exports = [
  ...
  },
  {
    ...
    SKU: 'G000008',
    description:
      'Messier 82 (also known as NGC 3034, Cigar Galaxy or M82) is a starburst galaxy in the constellation Ursa Major. A member of the M81 Group, it is about five times more luminous than the Milky Way and has a center one hundred times more luminous. The starburst activity is thought to have been triggered by interaction with neighboring galaxy M81. As the closest starburst galaxy to Earth, M82 is the prototypical example of this galaxy type. SN 2014J, a type Ia supernova, was discovered in the galaxy on 21 January 2014.',
    distance: 12,
    price: 2000,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:M82_HST_ACS_2006-14-a-large_web.jpg',
    inventory: 10,
    category: 'irregular',
  },
  {
  ...
  },
  {
    ...
    SKU: 'G000011',
    description:
      'The Comet Galaxy, a spiral galaxy located in the galaxy cluster Abell 2667, was found with the Hubble Space Telescope. This galaxy has slightly more mass than our Milky Way. It was detected on 2 March 2007. This unique spiral galaxy has an extended stream of bright blue knots and diffuse wisps of young stars. It rushes at 3.5 million km/h through the cluster Abell 2667 and therefore, like a comet, shows a tail, with a length of 600,000 light-years.',
    distance: 3200,
    price: 1200,
    imageUrl: 'https://en.wikipedia.org/wiki/File:CometGalaxy.jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
    ...
    price: 2000,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:Eso1524aArtist%E2%80%99s_impression_of_CR7_the_brightest_galaxy_in_the_early_Universe.jpg',
    inventory: 10,
    category: 'irregular',
  },
  {
    ...
    SKU: 'G000013',
    description:
      'NGC 4151 is an intermediate spiral Seyfert galaxy with weak inner ring structure located 15.8 megaparsecs from Earthin the constellation Canes Venatici. The galaxy was first mentioned by William Herschel on March 17, 1787; it was one of the two Seyfert galaxies described in the paper which defined the term. It is one of the nearest galaxies to Earth to contain an actively growing supermassive black hole; it was speculated that the nucleus may host a binary black hole, with about 40 million and about 10 million solar masses respectively, orbiting with a 15.8-year period. This is, however, still a matter of active debate. Some astronomers nickname it the "Eye of Sauron" from its appearance',
    distance: 52,
    price: 1200,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:NGC4151_Galaxy_from_the_Mount_Lemmon_SkyCenter_Schulman_Telescope_courtesy_Adam_Block.jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
    ...
    SKU: 'G000014',
    description:
      'NGC 6946, also known as the Fireworks Galaxy or Caldwell 12, is a face-on intermediate spiral galaxy with a small bright nucleus, whose location in the sky straddles the boundary between the northern constellations of Cepheus and Cygnus. Its distance from Earth is similar to the distance of M101 (NGC 5457) in the constellation Ursa Major. Both were once considered to be part of the Local Group, but are now known to be among the dozen bright spiral galaxies near the Milky Way but beyond the confines of the Local Group. NGC 6946 lies within the Virgo Supercluster.',
    distance: 25,
    price: 1200,
    imageUrl: 'https://en.wikipedia.org/wiki/File:NGC_6946.jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
    ...
    price: 1200,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:NGC4656_-_SDSS_DR14_(panorama).jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
    ...
    distance: 612,
    price: 3600,
    imageUrl: 'https://en.wikipedia.org/wiki/File:Hoag%27s_object.jpg',
    inventory: 10,
    category: 'elliptical',
  },
  {
    ...
    SKU: 'G000017',
    description:
      'The Large Magellanic Cloud (LMC) is a satellite galaxy of the Milky Way.The LMC is the second or third closest galaxy to the Milky Way, after the Sagittarius Dwarf Spheroidal (~16 kpc) and the possible dwarf irregular galaxy known as the Canis Major Overdensity. Based on readily visible stars and a mass of approximately 10 billion solar masses, the diameter of the LMC is about 14,000 light-years (4.3 kpc). It is roughly a hundredth as massive as the Milky Way and is the fourth largest galaxy in the Local Group, after the Andromeda Galaxy (M31), the Milky Way, and the Triangulum Galaxy (M33).',
    distance: 0.163,
    price: 2000,
    imageUrl: 'https://en.wikipedia.org/wiki/File:Large.mc.arp.750pix.jpg',
    inventory: 10,
    category: 'irregular',
  },
  {
    name: 'Lindsay-Shapley Ring',
    SKU: 'G000018',
    description:
      'AM 0644-741, also known as the Lindsay-Shapley Ring, is an unbarred lenticular galaxy, and a ring galaxy, in the southern constellation Volans. The yellowish nucleus was once the center of a normal spiral galaxy, and the ring which currently surrounds the center is 150,000 light years in diameter. The ring is theorized to have formed by a collision with another galaxy, which triggered a gravitational disruption that caused dust in the galaxy to condense and form stars, which forced it to then expand away from the galaxy and create a ring.',
    distance: 300,
    price: 3600,
    imageUrl: 'https://en.wikipedia.org/wiki/File:AM_0644-741.jpg',
    inventory: 10,
    category: 'elliptical',
  },
  {
    name: 'Little Sombrero',
    SKU: 'G000019',
    description:
      'NGC 7814 (also known as UGC 8 or Caldwell 43) is a spiral galaxy in the constellation Pegasus. The galaxy is seen edge-on from Earth. It is sometimes referred to as "the little sombrero", a miniature version of Messier 104. The star field behind NGC 7814 is known for its density of faint, remote galaxies as can be seen in the image here – in the same vein as the Hubble Deep Field.',
    distance: 40,
    price: 1200,
    imageUrl: 'https://en.wikipedia.org/wiki/File:N7814s.jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
  ...
  },
  {
    ...
    price: 2000,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:Snakes_and_Stones_NGC_4194.jpg',
    inventory: 10,
    category: 'irregular',
  },
  {
    ...
    SKU: 'G000022',
    description:
      'The Sculptor Dwarf Galaxy (also known as Sculptor Dwarf Elliptical Galaxy or the Sculptor Dwarf Spheroidal Galaxy, and formerly as the Sculptor System) is a dwarf spheroidal galaxy that is a satellite of the Milky Way. The galaxy lies within the constellation Sculptor. It was discovered in 1937 by American astronomer Harlow Shapley using the 24-inch Bruce refractor at Boyden Observatory. The Sculptor Dwarf contains only 4 percent of the carbon and other heavy elements in our own galaxy, the Milky Way, making it similar to primitive galaxies seen at the edge of the universe.',
    distance: 0.29,
    price: 3600,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:Sculptor_Dwarf_Galaxy_ESO.jpg',
    inventory: 10,
    category: 'elliptical',
  },
  {
    ...
    price: 1200,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:Merging_galaxies_NGC_4676_(captured_by_the_Hubble_Space_Telescope).jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
    ...
    SKU: 'G000024',
    description:
      'The Small Magellanic Cloud (SMC), or Nubecula Minor, is a dwarf galaxy near the Milky Way. Classified as a dwarf irregular galaxy, the SMC has a diameter of about 7,000 light-years, contains several hundred million stars, and has a total mass of approximately 7 billion solar masses. The SMC contains a central bar structure, and astronomers speculate that it was once a barred spiral galaxy that was disrupted by the Milky Way to become somewhat irregular. The SMC is among the nearest intergalactic neighbors of the Milky Way and is one of the most distant objects visible to the naked eye.',
    distance: 0.2,
    price: 2000,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:Small_Magellanic_Cloud_(Digitized_Sky_Survey_2).jpg',
    inventory: 10,
    category: 'irregular',
  },
  {
    ...
    SKU: 'G000025',
    description:
      "Mayall's Object (also classified under the Atlas of Peculiar Galaxies as Arp 148) is the result of two colliding galaxies within the constellation of Ursa Major. It was discovered by American astronomer Nicholas U. Mayall of the Lick Observatory on 13 March 1940, using the Crossley reflector. When first discovered, Mayall's Object was described as a peculiar nebula, shaped like a question mark. Originally theorized to represent a galaxy reacting with the intergalactic medium, it is now thought to represent the collision of two galaxies, resulting in a new object consisting of a ring-shaped galaxy with a tail emerging from it. It is thought that the collision between the two galaxies created a shockwave that initially drew matter into the center which then formed the ring.",
    distance: 450,
    price: 2000,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:Hubble_Interacting_Galaxy_Arp_148_(2008-04-24).jpg',
    inventory: 10,
    category: 'irregular',
  },
  {
    ...
    SKU: 'G000027',
    description:
      'NGC 4565 (also known as the Needle Galaxy or Caldwell 38) is an edge-on spiral galaxy in the constellation Coma Berenices. It lies close to the North Galactic Pole and has a visual magnitude of approximately 10. It is known as the Needle Galaxy for its narrow profile. First recorded in 1785 by William Herschel, it is a prominent example of an edge-on spiral galaxy.',
    distance: 43,
    price: 1200,
    imageUrl: 'https://en.wikipedia.org/wiki/File:Needle_Galaxy_4565.jpeg',
    inventory: 10,
    category: 'spiral',
  },
  {
    ...
    price: 2000,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:The_WLM_galaxy_on_the_edge_of_the_Local_Group.jpg',
    inventory: 10,
    category: 'irregular',
  },
  {
  ...
  },
  {
    ...
    distance: 12,
    price: 1200,
    imageUrl: 'https://en.wikipedia.org/wiki/File:Sculptor_Galaxy_up_Close.jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
  ...
  },
  {
    ...
    SKU: 'G000032',
    description:
      'Messier 83 or M83, also known as the Southern Pinwheel Galaxy and NGC 5236, is a barred spiral galaxy in the constellation borders of Hydra and Centaurus. Nicolas Louis de Lacaille discovered M83 on February 23, 1752 at the Cape of Good Hope. Charles Messier added it to his catalogue of nebulous objects (now known as the Messier Catalogue) in March 1781. It is one of the closest and brightest barred spiral galaxies in the sky, and is visible with binoculars. Its nickname of the Southern[a] Pinwheel derives from its resemblance to the Pinwheel Galaxy (M101).',
    distance: 15,
    price: 1200,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:Messier_83_(captured_by_ESO%27s_1.5-metre_Danish_telescope).jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
    ...
    distance: 30,
    price: 1200,
    imageUrl: 'https://en.wikipedia.org/wiki/File:Messier_63_GALEX_WikiSky.jpg',
    inventory: 10,
    category: 'spiral',
  },
  {
  ...
  },
  {
    ...
    SKU: 'G000035',
    description:
      'The Triangulum Galaxy is a spiral galaxy in the constellation Triangulum. It is catalogued as Messier 33 or NGC 598. The Triangulum Galaxy is the third-largest member of the Local Group of galaxies, behind the Milky Way and the Andromeda Galaxy (the largest). It is one of the most distant permanent objects that can be viewed with the naked eye.',
    distance: 3,
    price: 1200,
    imageUrl:
      'https://en.wikipedia.org/wiki/File:TriangulumGalaxy-HighRez-Hubble-20190111.png',
    inventory: 10,
    category: 'spiral',
  },
  {
    ...
    distance: 31,
    price: 1200,
    imageUrl: 'https://en.wikipedia.org/wiki/File:Messier51_sRGB.jpg',
    inventory: 10,
    category: 'spiral',
  },
];
